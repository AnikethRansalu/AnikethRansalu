...
```typescript
const AnikethRansalu = {
    location: "Sri Lanka 🇱🇰",
    education: "Computer Security Undergraduate & Graphic Designer",
    roles: ["Programmer", "GraphicDesigner", "AI Enthusiast"],
    currentFocus: ["Programming", "Gdesigning", "Web Designingn"],
